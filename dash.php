...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Roll number</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    if($show == 1 && $total==1){
        ...
        $i = 1;
        while($i<=$total){
            echo '<td style="vertical-align:middle;text-align:center"><a style="font-size:14px;font-family:RobotoSlab-Regular;font-weight:bold" href="dash.php?q=2&show='.$i.'">&nbsp;'.$i.'&nbsp;</a></td>';
            $i++;
        }
        echo '<td style="vertical-align:middle;text-align:center"><a style="font-size:14px;font-family:RobotoSlab-Regular;font-weight:bold" href="dash.php?q=2&show='.($show+1).'">&nbsp;>>&nbsp;</a></td>';
    }
...
function empty()
{
	...
	if(x=="")
	{
		alert("Total marks field is required");
		return false;
	}
	y=document.getElementById("right").value;
	if(y=="")
	{
		alert("Enter the score for right answer");
		return false;
	}
	z=document.getElementById("wrong").value;
	if(z=="")
	{
		alert("Enter the score for wrong answer");
		return false;
	}
	t=document.getElementById("time").value;
	if(t=="")
	{
		alert("Enter a value for time in minutes");
		return false;
	}
}
</script>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" style="margin-left:45%" class="btn btn-primary" value="Submit" class="btn btn-primary"  onClick="return empty()"/>
  </div>
</div>
