...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <div id="errormsg" style="font-size:14px;font-family:RobotoSlab-Regular;font-weight:normal;color:red"><?php
if (@$_GET['q7']) {
...
?>>Information Science Engineering</option>
...
?>>Electronics and Instrumentation Engineering</option>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="phno" name="phno" placeholder="Enter your mobile number" class="form-control input-md"  type="number" maxlength="10" value="<?php
if (isset($_GET['phno']))
{
echo $_GET['phno'];
}
...
<span href="#" data-target="#login" style="color:lightyellow">Online Quiz Portal</span>
</div>
